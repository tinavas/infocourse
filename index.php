...
</style></head><body><nav class="navbar navbar-default"><!--default--><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">TechEdu ++</a><ul class="nav navbar-nav"><li class="active"><a href="#">Home</a></li><li><a href="/news">News</a></li><li><a href="https://chat.techedu.cf">Chat</a></li><li><a href="/aboutus.php">About</a></li></ul></div></div></nav><!--.jumbotron.container
	h1.display-3
		img(src='/drawing.svg')
	p This academy can teach you how to be good at computer sciences--><div class="container"><div class="panel panel-primary"><div class="panel-heading"><h4>Tracks</h4></div><div class="panel-body"><?php include_once ($_SERVER["DOCUMENT_ROOT"] . "/lib/get_tracks.php");	?></div></div><div class="panel panel-primary"><div class="panel-heading"><h4>Seminars</h4></div><div class="panel-body"><?php include_once ($_SERVER["DOCUMENT_ROOT"] . "/lib/get_seminars.php");	?></div></div></div><footer><center><p>Copyrights © Tech Education++ 2016-2017</p></center></footer><script src="/js/jquery.min.js"></script><script src="/js/tether.min.js"></script><script src="/js/bootstrap.min.js"></script><script src="/js/material.min.js"></script><script src="/js/ripples.min.js"></script><script src="/js/snackbar.min.js"></script><script src="/js/jquery.nouislider.min.js"></script><script src="/js/main.js"></script></body></html>